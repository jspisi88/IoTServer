...
GET_URL = "iotskola2021spisic.westeurope.cloudapp.azure.com/api/telemetry/get"
POST_URL = "iotskola2021spisic.westeurope.cloudapp.azure.com/api/telemetry/post"
...
if __name__ == "__main__":
    ...
    client.subscribe('/algebra/spisic/Temperature')
    client.subscribe('/algebra/spisic/Heartrate')
    client.subscribe('/algebra/spisic/Battery')
    client.loop_forever()
